...
<?php 
//change array to have the page ID of where your [helpscout_desk] tag is
if ( ! isset( $_REQUEST['conversation_id'] ) && is_page( array( 874 ) ) ) {
	return;
} ?>
...
<form action="" method="post" enctype="multipart/form-data" id="hsd_message_form" class="form" role="form">
	...
	<div class="form-group">
		<label for="message_attachment"><?php _e( 'Add attachments', 'help-scout-desk' ) ?></label>
